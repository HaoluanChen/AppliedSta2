...
```{r}
modeldata3b <- combined %>% mutate(Series_Complete_18PlusPop_Pct_model = Series_Complete_18PlusPop_Pct/100)
...
In my opinion, the the third option is not appropriate in most of the case because it contains way too many covariates, we will not be able to extract useful information from it. 

First and second option depends on weather or not you are interested in the total count or average of the county level. Note that the average will suffer from problem of outlier 
